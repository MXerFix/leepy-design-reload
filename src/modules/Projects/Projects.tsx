            ...
            >
              <div className=' relative w-[70%] bg-white h-full px-5 py-4 '>
                ...
                <div className={`absolute bottom-4 left-5 text-sm flex flex-row items-center justify-center gap-1`}>
                  ...
                  <button className='bg-black border border-black px-2 h-6 flex items-center justify-center '>
              ...
              <div className=' w-[30%] h-full overflow-hidden '>
                <Image className='max-w-max relative right-[37%] h-full' src={item.img} alt={item.name} />
              </div>
            </div>
          ))}
        </div>
